			...
			public void run()
{
	...
	public void initialize() 
	{
		...
		try 
		{
			textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
		}
		...
		btnBoisson.addActionListener(new ActionListener()
		{
			...
			{	
				if (rdbtnAjouter.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.ajouter(Liste_De_Boissons.boisson1, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
				...
				else if (rdbtnEnlever.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.enlever(Liste_De_Boissons.boisson1, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
		...
		btnBoisson_1.addActionListener(new ActionListener()
		{
			...
			{	
				if (rdbtnAjouter.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.ajouter(Liste_De_Boissons.boisson2, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException | ListeVideException erreur)
					{
				...
				else if (rdbtnEnlever.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.enlever(Liste_De_Boissons.boisson2, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException erreur)
					{
		...
		btnBoisson_2.addActionListener(new ActionListener()
		{
			...
			{	
				if (rdbtnAjouter.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.ajouter(Liste_De_Boissons.boisson3, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException | ListeVideException erreur)
					{
				...
				else if (rdbtnEnlever.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.enlever(Liste_De_Boissons.boisson3, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException erreur)
					{
		...
		btnBoisson_3.addActionListener(new ActionListener()
		{
			...
			{	
				if (rdbtnAjouter.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.ajouter(Liste_De_Boissons.boisson4, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException | ListeVideException erreur)
					{
				...
				else if (rdbtnEnlever.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.enlever(Liste_De_Boissons.boisson4, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException erreur)
					{
		...
		btnBoisson_4.addActionListener(new ActionListener()
		{
			...
			{	
				if (rdbtnAjouter.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.ajouter(Liste_De_Boissons.boisson5, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException | ListeVideException erreur)
					{
				...
				else if (rdbtnEnlever.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.enlever(Liste_De_Boissons.boisson5, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException erreur)
					{
		...
		btnBoisson_5.addActionListener(new ActionListener()
		{
			...
			{	
				if (rdbtnAjouter.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.ajouter(Liste_De_Boissons.boisson6, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException | ListeVideException erreur)
					{
				...
				else if (rdbtnEnlever.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.enlever(Liste_De_Boissons.boisson6, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException erreur)
					{
		...
		btnBoisson_6.addActionListener(new ActionListener()
		{
			...
			{	
				if (rdbtnAjouter.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.ajouter(Liste_De_Boissons.boisson7, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException | ListeVideException erreur)
					{
				...
				else if (rdbtnEnlever.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.enlever(Liste_De_Boissons.boisson7, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException erreur)
					{
		...
		btnBoisson_7.addActionListener(new ActionListener()
		{
			...
			{	
				if (rdbtnAjouter.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.ajouter(Liste_De_Boissons.boisson8, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException | ListeVideException erreur)
					{
				...
				else if (rdbtnEnlever.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.enlever(Liste_De_Boissons.boisson8, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException erreur)
					{
		...
		btnBoisson_8.addActionListener(new ActionListener()
		{
			...
			{	
				if (rdbtnAjouter.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.ajouter(Liste_De_Boissons.boisson9, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException | ListeVideException erreur)
					{
				...
				else if (rdbtnEnlever.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.enlever(Liste_De_Boissons.boisson9, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException erreur)
					{
		...
		btnBoisson_9.setBounds(364, 146, 100, 23);
		...
		btnBoisson_9.addActionListener(new ActionListener()
		{
			...
			{	
				if (rdbtnAjouter.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.ajouter(Liste_De_Boissons.boisson10, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException | ListeVideException erreur)
					{
				...
				else if (rdbtnEnlever.isSelected() == true)
				{
					try
					{
						Interface_Graphique.t2.enlever(Liste_De_Boissons.boisson10, Integer.parseInt(textField.getText()));
						textPane.setText("Client :  "+ Interface_Graphique.getNom2() + "\n" + Interface_Graphique.t2.afficherTicket());
					}
					catch (BoissonInvalideException | QuantiteNegativeException erreur)
					{
